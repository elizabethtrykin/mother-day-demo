...
interface VoiceRecordButtonProps extends HTMLMotionProps<'button'> {
  isRecording: boolean;
...
export const VoiceRecordButton = ({
  ...
  const timeLeft = 10 - recordingTime;
    ...
    <ButtonContainer>
      ...
      >
        <span className="flex items-center gap-2">
          {isComplete ? 'Recording Complete' : isRecording ? `${timeLeft}s` : label}
          {isComplete ? (
